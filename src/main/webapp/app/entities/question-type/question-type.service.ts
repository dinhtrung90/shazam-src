...
export class QuestionTypeService {
    ...
    public resourceSearchUrl = SERVER_API_URL + 'api/_search/question-types';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IQuestionType[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
