...
import { SurveyResponseComponent } from 'app/entities/survey-response/survey-response.component';
...
describe('Component Tests', () => {
    describe('SurveyResponse Management Component', () => {
        let comp: SurveyResponseComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SurveyResponseComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.surveyResponses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
